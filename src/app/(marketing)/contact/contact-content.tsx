            ...
            <Card className="hover:border-emerald-500/50 hover:shadow-lg hover:shadow-emerald-500/5 transition-all duration-300">
              ...
              <CardContent>
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {/* Top row: Twitter, LinkedIn, Medium */}
                  <SocialLink
                  ...
                  />
                  {/* Bottom row: GitHub, Scholar, ORCID */}
                  <SocialLink
                  ...
                  <SocialLink
                    ...
                    icon={
                      <svg
                        ...
                        fill="currentColor"
                      >
                        <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-4.351 8.666c.559 0 .957-.396.957-.945s-.398-.945-.957-.945c-.559 0-.957.396-.957.945s.398.945.957.945zm-.611 1.334h1.203v7h-1.203v-7zm3.962 0h3.473c2.903 0 4.527 1.783 4.527 4.5 0 2.752-1.624 4.5-4.527 4.5h-3.473v-9zm1.222 7.778h2.17c2.145 0 3.388-1.266 3.388-3.278s-1.243-3.278-3.388-3.278h-2.17v6.556z" />
                      </svg>
                    }
                  />
                </div>
